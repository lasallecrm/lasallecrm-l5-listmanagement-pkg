...
class List_Email extends BaseModel
{
     ...
     * @var string
     */
    public $namespace_formprocessor = 'Lasallecrm\Listmanagement\FormProcessing\List_Emails';
    ...
    public function listlist() {
        return $this->hasMany('Lasallecrm\Listmanagement\Models\Listlist');
    }
    ...
    public function list_email() {
        return $this->hasMany('Lasallecrm\Listmanagement\Models\List_Email');
    }
